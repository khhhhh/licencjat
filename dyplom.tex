...
porusza się na tę samą odległość, a jego linie mają tę samą szerokość.
...
należy dodać parametry długości i szerokości linii utworzonej przez 
żółwia. 
...
W przykładzie przedstawionym w książce szerokość linii narysowanej
przez żółwia nie zmienia się. Rozszerzyłem przykład z podręcznika
i dodałem czynnik szerokości, przez który będzie mnożona grubość 
