...
która pozwala na tworzenie drzewa jako siatki wierzchołków. 
...
zrobił port tej biblioteki dla C++. Biblioteka w wersji C++ jest szybsza.
...
Nlohmann Json to biblioteka do obsługi danych formatu json. 
...
złożonych scen 3D za pomocą prostych prymitywów. Wykorzystywany jest do 
